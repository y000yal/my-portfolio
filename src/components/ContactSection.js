          ...
          <div className="contact-info">
            ...
            <div className="social-links-contact">
              ...
              <div className="social-icons">
                <a href="https://github.com/yoyallimbu" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                ...
                <a href="https://linkedin.com/in/yoyallimbu" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor">
